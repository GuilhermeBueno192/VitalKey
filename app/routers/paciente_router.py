...
from models.paciente import Paciente, InformacoesPrivadas  # SQLAlchemy models
from schemas.paciente_schemas import PacienteBase, PacienteCompleto, InformacoesPrivadasBase, PacienteUpdate, InformacoesPrivadasUpdate
from security.dependencies import autenticar_medico
...
@router.get("/paciente/{id}/completo", response_model=PacienteCompleto)
